...
if __name__ == '__main__':
    ...
    recorder = Recorder(
        ...
        model_name=f"grader/{args.grader_model}/{args.grader_model_name}" if args.grader_model_name else f"{args.grader_model}"
    )
    ...
    print(f"Evaluated model {args.grader_model} on dataset {dataset_name} with {len(values)} examples:")
