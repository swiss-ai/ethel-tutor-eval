...
data3 = [ #llama-3.2 french
    {"n_shots": "0", "accuracy": 0.472},
    {"n_shots": "2", "accuracy": 0.56},
    {"n_shots": "4", "accuracy": 0.58},
    {"n_shots": "6", "accuracy": 0.584},
    {"n_shots": "8", "accuracy": 0.576},
]
data4 = [ #llama-3.2 german
    {"n_shots": "0", "accuracy": 0.224},
    {"n_shots": "2", "accuracy": 0.574},
    {"n_shots": "4", "accuracy": 0.56},
    {"n_shots": "6", "accuracy": 0.536},
    {"n_shots": "8", "accuracy": 0.604}
]

datasets = [
    ("Llama-3.1 french", data1),
    ("Llama-3.1 german", data2),
    ("Llama-3.2 french", data3),
    ("Llama-3.2 german", data4)
]
